                  ...
                  <div class="datlich">
                     <form class="form-horizontal" method="POST" action="DatLichController">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-3">
                              <input type='text' required="true" ng-model='course.date' class='form-control'
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-2">
                              <select class="form-control" required="true" ng-init="buoiKham = 0"
                        ...
                        <div class="form-group">
                           ...
                           sĩ khám</label>
                           <div class="col-sm-4">
                              <select class="form-control" required="true" ng-model="bacSiId"
