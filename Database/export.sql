...
INSERT INTO BACSI(BACSI_ID,HOTEN,NGAYSINH,GIOITINH,CMND,SDT,EMAIL,DIACHI,CHUYENMON) VALUES(9,'Nguyen Thi Huong',TO_DATE('1994/02/08', 'yyyy/mm/dd'),0,'1234567','01234567890','nguyenthihuong@gmail.com','Thanh Hoa','Khoa phau thuat');
...
DELETE FROM BACSI WHERE BACSI_ID=9;
...
INSERT INTO LICHBIEU(PHONGKHAM_ID,BACSI_ID,NGAYLAM,BUOILAM,TRANGTHAI) VALUES(1,13,TO_DATE('2016/06/04', 'yyyy/mm/dd'),0,1);
INSERT INTO LICHBIEU(PHONGKHAM_ID,BACSI_ID,NGAYLAM,BUOILAM,TRANGTHAI) VALUES(1,13,'04-june-2016',1,1);
